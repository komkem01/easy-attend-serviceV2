...
type Student struct {
	...
	ClassroomID *uint  `gorm:"not null;uniqueIndex:idx_student_no_classroom" json:"classroom_id"`
	StudentNo   string `gorm:"type:varchar(20);not null;uniqueIndex:idx_student_no_classroom" json:"student_no"`
